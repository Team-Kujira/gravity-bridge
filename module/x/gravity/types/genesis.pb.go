...
type Params struct {
	...
	SlashFractionSignerSetTx                  cosmossdk_io_math.LegacyDec `protobuf:"bytes,13,opt,name=slash_fraction_signer_set_tx,json=slashFractionSignerSetTx,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_signer_set_tx"`
	SlashFractionBatch                        cosmossdk_io_math.LegacyDec `protobuf:"bytes,14,opt,name=slash_fraction_batch,json=slashFractionBatch,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_batch"`
	SlashFractionEthereumSignature            cosmossdk_io_math.LegacyDec `protobuf:"bytes,15,opt,name=slash_fraction_ethereum_signature,json=slashFractionEthereumSignature,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_ethereum_signature"`
	SlashFractionConflictingEthereumSignature cosmossdk_io_math.LegacyDec `protobuf:"bytes,16,opt,name=slash_fraction_conflicting_ethereum_signature,json=slashFractionConflictingEthereumSignature,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_conflicting_ethereum_signature"`
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
