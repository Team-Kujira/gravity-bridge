...
// 	totalSupply := sdk.NewCoins(math.NewInt64Coin("stake", 100000000))
...
// 			amt := sdk.NewCoins(math.NewInt64Coin("stake", 500000))
...
// func (s *StakingKeeperMock) ValidatorQueueIterator(ctx sdk.Context, endTime time.Time, endHeight int64) corestore.Iterator {
...
// func (s *StakingKeeperMock) Slash(sdk.Context, sdk.ConsAddress, int64, int64, math.LegacyDec) sdkmath.Int {
